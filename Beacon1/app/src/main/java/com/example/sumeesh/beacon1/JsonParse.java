 ...
 */
public class JsonParse extends AsyncTask<String,Void,ArrayList<Product>> {

    MainActivity activity;
    ArrayList<Product> data_list = new ArrayList<>();
    Product data;
    ...
    @Override
    protected void onPostExecute(ArrayList<Product> data_list) {
